...
namespace Dissonance.Editor.Windows
{
    public static class MenuSetup
    {
        ...
        {
            var query = EditorMetadata.GetQueryStringWithIntegrations("menu");
        ...
        {
            var query = EditorMetadata.GetQueryStringWithIntegrations("menu");
            Application.OpenURL(string.Format("https://placeholder-software.co.uk/dissonance/releases/{0}.html{1}#integrations", DissonanceComms.Version, query));
        }

        [MenuItem("Window/Dissonance/Support/Online Documentation", priority = 3), UsedImplicitly]
        private static void Documentation()
        {
            Application.OpenURL("https://placeholder-software.co.uk/dissonance/docs");
        }

        [MenuItem("Window/Dissonance/Support/Report A Bug", priority = 4), UsedImplicitly]
        private static void IssueTracker()
        {
            Application.OpenURL("https://github.com/Placeholder-Software/Dissonance/issues");
        }

        [MenuItem("Window/Dissonance/Rate And Review", priority = 5), UsedImplicitly]
